...
# 문제
https://inha.codetree.ai/missions/2/problems/puyo-puyo/submissions
# 풀이
CanGo 함수를 이용해서 갈 수 있는지 확인하고 갈 수 있을 때마다 블럭 수를 증가한다 그리고 블럭 수가 일정 수를 넘으면 그 수를 변수에 담아주는 식으로 푼다.
# 코드
```
#include <iostream>
using namespace std;
