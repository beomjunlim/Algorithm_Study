...
# 문제
https://inha.codetree.ai/missions/2/problems/minimum-diff-partition/submissions
# 풀이
먼저 가능한 최대의 합을 계산하고 만들 수 있는 합을 모두 만들어보고 차이를 계산한다.
# 콛드
```
#include <iostream>
#include <algorithm>
...
# 문제
https://inha.codetree.ai/missions/2/problems/select-proper-clothes/submissions
# 풀이
세개의 배열을 입력받고 마지막날에 입은 옷을 정하고 그 전에 입은 옷들을 비교하며 배열을 업데이트한다.
# 코드
```
#include <iostream>
#include <climits>
